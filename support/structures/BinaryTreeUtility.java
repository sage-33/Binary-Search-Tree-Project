...
public interface BinaryTreeUtility {
	 ...
	 * </p>
	 * 
	 * @param root the root {@link BinaryTreeNode} to use for this {@link Iterator}
	 ...
	 * traveled from {@code root} to some child {@link BinaryTreeNode}. For example:
	 * </p>
	 * 
	 * <pre>
	 * noChildren ->  A
	 ...
	 * </pre>
	 * 
	 * @param root the root {@link BinaryTreeNode} to examine
	 * @throws NullPointerException if root is {@code null}
	...
	/**
	 * A binary tree is said to be balanced if for each node in the tree the depth
	 * of each nodes children differs by at most some tolerance. Given a
	 * {@link BinaryTreeNode} and a tolerance, returns {@code true} if {@code root}
	 * is balanced and {@code false} otherwise.
	 * 
	 * @param root the root {@link BinaryTreeNode} to examine
	 * @param int  the maximum tolerance to decide if the tree is balanced
	 * @return {@code true} if {@code root} is balanced and {@code false} otherwise.
	 * @throws NullPointerException     if {@code root} is {@code null}
	 * @throws IllegalArgumentException if {@code tolerance} is less than 0
	 */
	 ...
	 * <li>The left subtree of a node contains only nodes with values less than or
	 * equal to the value stored in {@code root}.</li>
	 ...
	 * </p>
	 * 
	 * @param root the {@link BinaryTreeNode} to examine
