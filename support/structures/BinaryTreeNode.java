 ...
 * to store some data (cannot hold null) and may have a left child and a right
 * child.
 * 
...
public interface BinaryTreeNode<T> {
	...
	/**
	 * Returns {@code true} if this {@link BinaryTreeNode} has a left child and
	 * {@code false} otherwise
	 * 
	 * @return {@code true} if this {@link BinaryTreeNode} has a left child and
	 *         {@code false} otherwise
	 */
	public boolean hasLeftChild();

	/**
	 * Returns {@code true} if this {@link BinaryTreeNode} has a right child and
	 * {@code false} otherwise.
	 * 
	 * @return {@code true} if this {@link BinaryTreeNode} has a right child and
	 *         {@code false} otherwise.
	 */
	...
	/**
	 * Sets the left child of this {@link BinaryTreeNode}. If {@code left} is
	 * {@code null} then this {@link BinaryTreeNode} will have no child.
	 * 
	 */
	public void setLeftChild(BinaryTreeNode<T> left);

	/**
	 * Sets the right child of this {@link BinaryTreeNode}. If {@code right} is
	 * {@code null} then this {@link BinaryTreeNode} will have no child.
	 * 
	 */
